...
export declare namespace Status {
    const STATE_WARNINGS: number;
    const STATE_ERRORS: number;
    const RESULT_ERROR: number;
    const RESULT_OK: number;
    const RESULT_NO_DATA: number;
    const RESULT_SEGMENT: number;
}
...
export declare namespace PluginManager {
    const TYPE_PROVIDER: number;
    const TYPE_FIRST_NON_LIB: number;
    const TYPE_AUTH_SERVER: number;
    const TYPE_AUTH_CLIENT: number;
    const TYPE_AUTH_USER_MANAGEMENT: number;
    const TYPE_EXTERNAL_ENGINE: number;
    const TYPE_TRACE: number;
    const TYPE_WIRE_CRYPT: number;
    const TYPE_DB_CRYPT: number;
    const TYPE_KEY_HOLDER: number;
    const TYPE_COUNT: number;
}
...
export declare namespace ConfigManager {
    const DIR_BIN: number;
    const DIR_SBIN: number;
    const DIR_CONF: number;
    const DIR_LIB: number;
    const DIR_INC: number;
    const DIR_DOC: number;
    const DIR_UDF: number;
    const DIR_SAMPLE: number;
    const DIR_SAMPLEDB: number;
    const DIR_HELP: number;
    const DIR_INTL: number;
    const DIR_MISC: number;
    const DIR_SECDB: number;
    const DIR_MSG: number;
    const DIR_LOG: number;
    const DIR_GUARD: number;
    const DIR_PLUGINS: number;
    const DIR_COUNT: number;
}
...
export declare namespace Statement {
    const PREPARE_PREFETCH_NONE: number;
    const PREPARE_PREFETCH_TYPE: number;
    const PREPARE_PREFETCH_INPUT_PARAMETERS: number;
    const PREPARE_PREFETCH_OUTPUT_PARAMETERS: number;
    const PREPARE_PREFETCH_LEGACY_PLAN: number;
    const PREPARE_PREFETCH_DETAILED_PLAN: number;
    const PREPARE_PREFETCH_AFFECTED_RECORDS: number;
    const PREPARE_PREFETCH_FLAGS: number;
    const PREPARE_PREFETCH_METADATA: number;
    const PREPARE_PREFETCH_ALL: number;
    const FLAG_HAS_CURSOR: number;
    const FLAG_REPEAT_EXECUTE: number;
    const CURSOR_TYPE_SCROLLABLE: number;
}
...
export declare namespace Auth {
    const AUTH_FAILED: number;
    const AUTH_SUCCESS: number;
    const AUTH_MORE_DATA: number;
    const AUTH_CONTINUE: number;
}
...
export declare namespace User {
    const OP_USER_ADD: number;
    const OP_USER_MODIFY: number;
    const OP_USER_DELETE: number;
    const OP_USER_DISPLAY: number;
    const OP_USER_SET_MAP: number;
    const OP_USER_DROP_MAP: number;
}
...
export declare namespace ExternalTrigger {
    const TYPE_BEFORE: number;
    const TYPE_AFTER: number;
    const TYPE_DATABASE: number;
    const ACTION_INSERT: number;
    const ACTION_UPDATE: number;
    const ACTION_DELETE: number;
    const ACTION_CONNECT: number;
    const ACTION_DISCONNECT: number;
    const ACTION_TRANS_START: number;
    const ACTION_TRANS_COMMIT: number;
    const ACTION_TRANS_ROLLBACK: number;
    const ACTION_DDL: number;
}
...
export declare namespace XpbBuilder {
    const DPB: number;
    const SPB_ATTACH: number;
    const SPB_START: number;
    const TPB: number;
}
...
export declare namespace TraceConnection {
    const KIND_DATABASE: number;
    const KIND_SERVICE: number;
}
...
export declare namespace TraceTransaction {
    const ISOLATION_CONSISTENCY: number;
    const ISOLATION_CONCURRENCY: number;
    const ISOLATION_READ_COMMITTED_RECVER: number;
    const ISOLATION_READ_COMMITTED_NORECVER: number;
}
...
export declare namespace TraceTrigger {
...
export declare namespace TracePlugin {
    const RESULT_SUCCESS: number;
    const RESULT_FAILED: number;
    const RESULT_UNAUTHORIZED: number;
    const SWEEP_STATE_STARTED: number;
    const SWEEP_STATE_FINISHED: number;
    const SWEEP_STATE_FAILED: number;
    const SWEEP_STATE_PROGRESS: number;
}
...
export declare namespace TraceFactory {
    const TRACE_EVENT_ATTACH: number;
    const TRACE_EVENT_DETACH: number;
    const TRACE_EVENT_TRANSACTION_START: number;
    const TRACE_EVENT_TRANSACTION_END: number;
    const TRACE_EVENT_SET_CONTEXT: number;
    const TRACE_EVENT_PROC_EXECUTE: number;
    const TRACE_EVENT_TRIGGER_EXECUTE: number;
    const TRACE_EVENT_DSQL_PREPARE: number;
    const TRACE_EVENT_DSQL_FREE: number;
    const TRACE_EVENT_DSQL_EXECUTE: number;
    const TRACE_EVENT_BLR_COMPILE: number;
    const TRACE_EVENT_BLR_EXECUTE: number;
    const TRACE_EVENT_DYN_EXECUTE: number;
    const TRACE_EVENT_SERVICE_ATTACH: number;
    const TRACE_EVENT_SERVICE_START: number;
    const TRACE_EVENT_SERVICE_QUERY: number;
    const TRACE_EVENT_SERVICE_DETACH: number;
    const TRACE_EVENT_ERROR: number;
    const TRACE_EVENT_SWEEP: number;
    const TRACE_EVENT_FUNC_EXECUTE: number;
    const TRACE_EVENT_MAX: number;
}
